...
public class ChargenServer {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("The port argument is:" + port);
        ...
        for (byte i = CHAR_SPACE; i <= '~'; i++) {
            rotation[i - CHAR_SPACE] = i;
            rotation[i + 95 - CHAR_SPACE] = i;
        }
        ...
        try {
            ...
            //register serverChannel to the selector
        ...
        while (true) {
            try {
                ...
                //select a set of kyes whose corresponding channels are read for I/O operations.
                int selectors = selector.select();
            ...
            while (iterator.hasNext()) {
                ...
                try {
                    if (key.isAcceptable()) {
                        System.out.println("key is acceptable : " + key.readyOps());
                        ...
                        System.out.println("key is writable : " + key.readyOps());
                        ...
                        if (!buffer.hasRemaining()) {
                            ...
                            int position = first - CHAR_SPACE + 1;
                            ...
                            System.out.println("key is not accetable or writable : " + key.readyOps());
                        }
